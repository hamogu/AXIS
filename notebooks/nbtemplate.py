...
logo = Image('logo.png', height=80, width=80)
...
def get_axis_status():
    try:
        with DisableLogger():
            import marxslynx.version as v
    except ImportError:
        return 'Lynx/AXIS code cannot be imported. No version information is available.'
    return 'Lynx/AXIS python code version ' + parse_git_scm_version(v.version)
